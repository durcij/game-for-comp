...
public class ProjectileFuria : MonoBehaviour {
	...
	GameObject player;
	PlayerMovementFuria playerData;
	...
	void Awake () {
		...
		player = GameObject.Find("Furia");

		speed = 4.5f;

		playerData = player.GetComponent<PlayerMovementFuria>();
