...
public class PlayerMovementFuria : MonoBehaviour {
  ...
  AudioSource attack;
	...
	public string fireButton = "Fire1_P3";

	public string horizontalControl = "Horizontal_P3";
	public string verticalControl = "Vertical_P3";
	...
	void Awake () {
		...
		pain = GameObject.Find("FuriaHurtBox").GetComponent<AudioSource>();
		vulnerable = true;
	}
  ...
  void AnimatingIdle(bool isFacingLeft, bool isFacingRight, bool isFacingForward, bool isFacingBackward, bool isMovedLeft, bool isMovedRight, bool isMovedForward, bool isMovedBackward, bool hurt) {
	...
	void OnTriggerEnter2D (Collider2D other){
		if (other.tag == "Nullos" || other.tag == "Risio Projectile" || other.tag == "Tristitia Projectile" || other.tag == "Dormio Projectile" || other.tag == "Dilectio Projectile" || other.tag == "Verecundia Projectile" || other.tag == "Invidia Projectile" || other.tag == "Mercuria Projectile") {
			if (vulnerable) {
				hurt = true;
			}
		}
